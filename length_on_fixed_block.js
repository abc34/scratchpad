(function()
{
  ...
  console.log("N = %d, total = %o", N, c, c<Number.MAX_SAFE_INTEGER);
  ...
  /*N>54 происходит потеря точности представления double при превышении Number.MAX_SAFE_INTEGER=2^53-1*/
}
)();
